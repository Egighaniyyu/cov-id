...
<body>
    ...
    <section id="table-provinsi">
        <div class="big-title text-center">
            <h1>Data RS Rujukan</h1>
        </div>
        </p>
        <div class="container ">
            <div class="row">
                @foreach ($dataRS as $data)
                <div class="col-sm-12 col-lg-5 table-data m-auto">
                    <p class="title-rs">{{$data['province']}}</p>
                    <table>
                        <tr>
                            <td class="body-text" style="vertical-align: top" width=100px>Nama RS </td>
                            <td class="body-text">: {{$data['name']}}</td>
                        </tr>
                        <tr>
                            <td class="body-text" style="vertical-align: top">Alamat </td>
                            <td class="body-text">: {{$data['address']}}</td>
                        </tr>
                        <tr>
                            <td class="body-text" style="vertical-align: top">Regional </td>
                            <td class="body-text">: {{$data['region']}}</td>
                        </tr>
                        <tr>
                            <td class="body-text" style="vertical-align: top">Kontak </td>
                            <td class="body-text">: {{$data['phone']}}</td>
                        </tr>
                    </table>
                </div>
                @endforeach
